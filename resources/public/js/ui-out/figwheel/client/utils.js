...
return (new CustomEvent(event_name,(function (){var obj52151 = {"detail":data};
return obj52151;
})()));
} else {
...
var f = (function (){var pred__52158 = cljs.core._EQ_;
var expr__52159 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__52158.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__52159))){
return ((function (pred__52158,expr__52159){
return (function (p1__52152_SHARP_){
return console.warn(p1__52152_SHARP_);
});
;})(pred__52158,expr__52159))
} else {
if(cljs.core.truth_(pred__52158.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__52159))){
return ((function (pred__52158,expr__52159){
return (function (p1__52153_SHARP_){
return console.debug(p1__52153_SHARP_);
});
;})(pred__52158,expr__52159))
} else {
if(cljs.core.truth_(pred__52158.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__52159))){
return ((function (pred__52158,expr__52159){
return (function (p1__52154_SHARP_){
return console.error(p1__52154_SHARP_);
});
;})(pred__52158,expr__52159))
} else {
return ((function (pred__52158,expr__52159){
return (function (p1__52155_SHARP_){
return console.log(p1__52155_SHARP_);
});
;})(pred__52158,expr__52159))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__52162){
var map__52163 = p__52162;
var map__52163__$1 = ((((!((map__52163 == null)))?((((map__52163.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52163.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52163):map__52163);
var opts = map__52163__$1;
var eval_fn = cljs.core.get.call(null,map__52163__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__52165_SHARP_){
return new_def.callback(p1__52165_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__52167,(0),null);
var v = cljs.core.nth.call(null,vec__52167,(1),null);
...
}catch (e52172){if((e52172 instanceof Error)){
var e = e52172;
return not_found;
} else {
throw e52172;
...
//# sourceMappingURL=utils.js.map?rel=1510360407103
