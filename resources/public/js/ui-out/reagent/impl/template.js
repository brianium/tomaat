...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__33442__auto__,writer__33443__auto__,opt__33444__auto__){
return cljs.core._write.call(null,writer__33443__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__41178 = o;
(G__41178[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__41179__delegate = function (args){
...
while (G__41180__i < G__41180__a.length) {G__41180__a[G__41180__i] = arguments[G__41180__i + 0]; ++G__41180__i;}
  args = new cljs.core.IndexedSeq(G__41180__a,0,null);
} 
return G__41179__delegate.call(this,args);};
G__41179.cljs$lang$maxFixedArity = 0;
G__41179.cljs$lang$applyTo = (function (arglist__41181){
var args = cljs.core.seq(arglist__41181);
...
if(cljs.core.truth_((function (){var and__32759__auto__ = !((jsprops == null));
if(and__32759__auto__){
var and__32759__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__32759__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__32759__auto____$1;
}
} else {
...
var G__41184 = jsprops;
(G__41184["defaultValue"] = value);

(G__41184["onChange"] = ((function (G__41184,v,value,on_change){
return (function (p1__41183_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__41183_SHARP_);
});})(G__41184,v,value,on_change))
);
...
var vec__41187 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__41187,(0),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___41191 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5282__auto___41191 == null)){
} else {
var key_41192 = temp__5282__auto___41191;
(jsprops["key"] = key_41192);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__41193 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__41193["name"] = c);
...
var len__34048__auto___41198 = arguments.length;
var i__34049__auto___41199 = (0);
while(true){
if((i__34049__auto___41199 < len__34048__auto___41198)){
args__34055__auto__.push((arguments[i__34049__auto___41199]));

var G__41200 = (i__34049__auto___41199 + (1));
i__34049__auto___41199 = G__41200;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__34056__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq41196){
var G__41197 = cljs.core.first.call(null,seq41196);
var seq41196__$1 = cljs.core.next.call(null,seq41196);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__41197,seq41196__$1);
});
...
break;
default:
var G__41203 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__41203;
continue;
...
var n__33814__auto___41205 = a.length;
var i_41206 = (0);
while(true){
if((i_41206 < n__33814__auto___41205)){
(a[i_41206] = reagent.impl.template.as_element.call(null,(a[i_41206])));

var G__41207 = (i_41206 + (1));
i_41206 = G__41207;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__33814__auto___41208 = a.length;
var i_41209 = (0);
while(true){
if((i_41209 < n__33814__auto___41208)){
var val_41210 = (a[i_41209]);
if((cljs.core.vector_QMARK_.call(null,val_41210)) && ((reagent.impl.template.key_from_vec.call(null,val_41210) == null))){
(o["no-key"] = true);
} else {
}

(a[i_41209] = reagent.impl.template.as_element.call(null,val_41210));

var G__41211 = (i_41209 + (1));
i_41209 = G__41211;
continue;
} else {
}
...
var ctx = ({});
var vec__41212 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__41212,(0),null);
var derefed = cljs.core.nth.call(null,vec__41212,(1),null);
...
var G__41215 = (cljs.core.count.call(null,argv) - first_child);
switch (G__41215) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__41215){
