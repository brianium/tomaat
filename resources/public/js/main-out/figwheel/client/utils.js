...
return (new CustomEvent(event_name,(function (){var obj37594 = {"detail":data};
return obj37594;
})()));
} else {
...
var f = (function (){var pred__37601 = cljs.core._EQ_;
var expr__37602 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37601.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37602))){
return ((function (pred__37601,expr__37602){
return (function (p1__37595_SHARP_){
return console.warn(p1__37595_SHARP_);
});
;})(pred__37601,expr__37602))
} else {
if(cljs.core.truth_(pred__37601.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37602))){
return ((function (pred__37601,expr__37602){
return (function (p1__37596_SHARP_){
return console.debug(p1__37596_SHARP_);
});
;})(pred__37601,expr__37602))
} else {
if(cljs.core.truth_(pred__37601.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37602))){
return ((function (pred__37601,expr__37602){
return (function (p1__37597_SHARP_){
return console.error(p1__37597_SHARP_);
});
;})(pred__37601,expr__37602))
} else {
return ((function (pred__37601,expr__37602){
return (function (p1__37598_SHARP_){
return console.log(p1__37598_SHARP_);
});
;})(pred__37601,expr__37602))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37605){
...
var opts = map__37606__$1;
var eval_fn = cljs.core.get.call(null,map__37606__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37608_SHARP_);
});})(new_def))
);
...
return (function (p__37609){
var vec__37610 = p__37609;
var ky = cljs.core.nth.call(null,vec__37610,(0),null);
var v = cljs.core.nth.call(null,vec__37610,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1510229216005
