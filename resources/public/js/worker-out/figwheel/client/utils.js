...
return (new CustomEvent(event_name,(function (){var obj45018 = {"detail":data};
return obj45018;
})()));
} else {
...
var f = (function (){var pred__45025 = cljs.core._EQ_;
var expr__45026 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__45025.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__45026))){
return ((function (pred__45025,expr__45026){
return (function (p1__45019_SHARP_){
return console.warn(p1__45019_SHARP_);
});
;})(pred__45025,expr__45026))
} else {
if(cljs.core.truth_(pred__45025.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__45026))){
return ((function (pred__45025,expr__45026){
return (function (p1__45020_SHARP_){
return console.debug(p1__45020_SHARP_);
});
;})(pred__45025,expr__45026))
} else {
if(cljs.core.truth_(pred__45025.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__45026))){
return ((function (pred__45025,expr__45026){
return (function (p1__45021_SHARP_){
return console.error(p1__45021_SHARP_);
});
;})(pred__45025,expr__45026))
} else {
return ((function (pred__45025,expr__45026){
return (function (p1__45022_SHARP_){
return console.log(p1__45022_SHARP_);
});
;})(pred__45025,expr__45026))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__45029){
...
var opts = map__45030__$1;
var eval_fn = cljs.core.get.call(null,map__45030__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__45032_SHARP_);
});})(new_def))
);
...
return (function (p__45038){
var vec__45039 = p__45038;
var ky = cljs.core.nth.call(null,vec__45039,(0),null);
var v = cljs.core.nth.call(null,vec__45039,(1),null);
...
}catch (e45052){if((e45052 instanceof Error)){
var e = e45052;
return not_found;
} else {
throw e45052;
...
//# sourceMappingURL=utils.js.map?rel=1510360395233
