...
return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.timer","div.timer",396383019)], null),cljs.core.interpose.call(null,":",cljs.core.mapv.call(null,(function (p1__17262_SHARP_){
return goog.string.format("%02d",p1__17262_SHARP_);
}),time)));
});
ui.main.button = (function ui$main$button(var_args){
var args__12990__auto__ = [];
var len__12983__auto___17268 = arguments.length;
var i__12984__auto___17269 = (0);
while(true){
if((i__12984__auto___17269 < len__12983__auto___17268)){
args__12990__auto__.push((arguments[i__12984__auto___17269]));

var G__17270 = (i__12984__auto___17269 + (1));
i__12984__auto___17269 = G__17270;
continue;
} else {
}
break;
...
return ui.main.button.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__12991__auto__);
});

ui.main.button.cljs$core$IFn$_invoke$arity$variadic = (function (p__17265,children){
...
var on_click = cljs.core.get.call(null,map__17266__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
...
ui.main.button.cljs$lang$applyTo = (function (seq17263){
var G__17264 = cljs.core.first.call(null,seq17263);
var seq17263__$1 = cljs.core.next.call(null,seq17263);
return ui.main.button.cljs$core$IFn$_invoke$arity$variadic(G__17264,seq17263__$1);
});

ui.main.main_screen = (function ui$main$main_screen(p__17271){
...
var toggle = cljs.core.get.call(null,map__17272__$1,new cljs.core.Keyword(null,"toggle","toggle",1291842030));
var start = cljs.core.get.call(null,map__17272__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.call(null,map__17272__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var time = cljs.core.get.call(null,map__17272__$1,new cljs.core.Keyword(null,"time","time",1385887882));
var started_QMARK_ = cljs.core.get.call(null,map__17272__$1,new cljs.core.Keyword(null,"started?","started?",-1301062863));
