...
var G__40835 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__40835;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__40837 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__40837,ch);
...
if(("\\" === ch__$1)){
var ch_40846__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_40846__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_40846__$2);
} else {
}

var G__40847 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__40847;
continue;
}
}
...
var vec__40994 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__40994,(0),null);
var start_column = cljs.core.nth.call(null,vec__40994,(1),null);
...
var G__41026 = cljs.core.conj_BANG_.call(null,a,form);
a = G__41026;
continue;
}
}
...
var _STAR_read_delim_STAR_41027 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_41027;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__41034 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41034,(0),null);
var start_column = cljs.core.nth.call(null,vec__41034,(1),null);
...
var vec__41037 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41037,(0),null);
var end_column = cljs.core.nth.call(null,vec__41037,(1),null);
...
var vec__41054 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41054,(0),null);
var start_column = cljs.core.nth.call(null,vec__41054,(1),null);
...
var vec__41057 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41057,(0),null);
var end_column = cljs.core.nth.call(null,vec__41057,(1),null);
...
var vec__41070 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41070,(0),null);
var end_column = cljs.core.nth.call(null,vec__41070,(1),null);
...
var sb = (function (){var G__41081 = (new goog.string.StringBuffer());
G__41081.append(initch);
...
var G__41087 = (function (){var G__41083 = sb;
G__41083.append(ch);

return G__41083;
})();
var G__41088 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__41087;
ch = G__41088;
continue;
}
...
switch (G__41096) {
case "\\":
var G__41101 = (function (){var G__41097 = sb;
G__41097.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__41097;
})();
var G__41102 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41101;
ch = G__41102;
continue;
...
break;
default:
var G__41103 = (function (){var G__41098 = sb;
G__41098.append(ch);

return G__41098;
})();
var G__41104 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41103;
ch = G__41104;
continue;
...
var vec__41108 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41108,(0),null);
var end_column = cljs.core.nth.call(null,vec__41108,(1),null);
...
var vec__41113 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41113,(0),null);
var column = cljs.core.nth.call(null,vec__41113,(1),null);
...
var vec__41142 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41142,(0),null);
var column = cljs.core.nth.call(null,vec__41142,(1),null);
...
var vec__41150 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41150,(0),null);
var column = cljs.core.nth.call(null,vec__41150,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__41170 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41170,(0),null);
var start_column = cljs.core.nth.call(null,vec__41170,(1),null);
...
var vec__41173 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41173,(0),null);
var end_column = cljs.core.nth.call(null,vec__41173,(1),null);
...
var G__41181 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__41181,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_41186 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_41186;
}});
...
var G__41195 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__41195,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__41195,rdr,first_line);
...
var G__41245 = matched;
var G__41246 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__41245;
finished = G__41246;
continue;
} else {
...
var _STAR_suppress_read_STAR_41252 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_41252;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env41265 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__41266 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41266,"(");
...
var G__41272 = (i + (1));
var G__41273 = cljs.core.conj_BANG_.call(null,args,(function (){var or__30072__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__30072__auto__)){
return or__30072__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env41265;
}});
/**
...
var ch = temp__5276__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__41318 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__41318);
...
var G__41329 = cljs.core.next.call(null,s__$1);
var G__41330 = ret;
s__$1 = G__41329;
r = G__41330;
continue;
...
var G__41337 = cljs.core.next.call(null,s);
var G__41338 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__41337;
key_vals = G__41338;
continue;
} else {
...
var gensym_env41422 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env41422;
}});
...
var temp__5276__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__41431 = token;
var G__41431__$1 = (((G__41431 == null))?null:cljs.core.subs.call(null,G__41431,(1)));
var G__41431__$2 = (((G__41431__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41431__$1));
var G__41431__$3 = (((G__41431__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41431__$2));
var G__41431__$4 = (((G__41431__$3 == null))?null:cljs.core.symbol.call(null,G__41431__$3));
if((G__41431__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__41431__$4);
}
})():(function (){var G__41432 = token;
var G__41432__$1 = (((G__41432 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41432));
if((G__41432__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41432__$1);
}
})()
));
if(cljs.core.truth_(temp__5276__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__41636,reader){
...
var opts = map__41637__$1;
var eof = cljs.core.get.call(null,map__41637__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1510360393603
