...
return (new CustomEvent(event_name,(function (){var obj38079 = {"detail":data};
return obj38079;
})()));
} else {
...
var f = (function (){var pred__38090 = cljs.core._EQ_;
var expr__38091 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__38090.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__38091))){
return ((function (pred__38090,expr__38091){
return (function (p1__38080_SHARP_){
return console.warn(p1__38080_SHARP_);
});
;})(pred__38090,expr__38091))
} else {
if(cljs.core.truth_(pred__38090.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__38091))){
return ((function (pred__38090,expr__38091){
return (function (p1__38081_SHARP_){
return console.debug(p1__38081_SHARP_);
});
;})(pred__38090,expr__38091))
} else {
if(cljs.core.truth_(pred__38090.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__38091))){
return ((function (pred__38090,expr__38091){
return (function (p1__38082_SHARP_){
return console.error(p1__38082_SHARP_);
});
;})(pred__38090,expr__38091))
} else {
return ((function (pred__38090,expr__38091){
return (function (p1__38083_SHARP_){
return console.log(p1__38083_SHARP_);
});
;})(pred__38090,expr__38091))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__38112){
...
var eval_fn = cljs.core.get.call(null,map__38113__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__38115_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__38130,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1510360382357
