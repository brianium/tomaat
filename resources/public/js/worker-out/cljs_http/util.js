...
var vec__51820 = ((cljs.core.map_QMARK_.call(null,credentials))?cljs.core.map.call(null,credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471)], null)):credentials);
var username = cljs.core.nth.call(null,vec__51820,(0),null);
var password = cljs.core.nth.call(null,vec__51820,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__51823){
...
var scheme = cljs.core.get.call(null,map__51824__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.call(null,map__51824__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.call(null,map__51824__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.call(null,map__51824__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.call(null,map__51824__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__51826 = (new goog.Uri());
G__51826.setScheme(cljs.core.name.call(null,(function (){var or__30072__auto__ = scheme;
...
return cljs.core.reduce.call(null,(function (p1__51828_SHARP_,p2__51827_SHARP_){
var vec__51829 = clojure.string.split.call(null,p2__51827_SHARP_,/:\s+/);
var k = cljs.core.nth.call(null,vec__51829,(0),null);
var v = cljs.core.nth.call(null,vec__51829,(1),null);
if((clojure.string.blank_QMARK_.call(null,k)) || (clojure.string.blank_QMARK_.call(null,v))){
return p1__51828_SHARP_;
} else {
return cljs.core.assoc.call(null,p1__51828_SHARP_,clojure.string.lower_case.call(null,k),v);
}
...
//# sourceMappingURL=util.js.map?rel=1510143452193
