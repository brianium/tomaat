...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30743__auto__,writer__30744__auto__,opt__30745__auto__){
return cljs.core._write.call(null,writer__30744__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__48740 = o;
(G__48740[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__48742__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__48742 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__48743__i = 0, G__48743__a = new Array(arguments.length -  0);
while (G__48743__i < G__48743__a.length) {G__48743__a[G__48743__i] = arguments[G__48743__i + 0]; ++G__48743__i;}
  args = new cljs.core.IndexedSeq(G__48743__a,0,null);
} 
return G__48742__delegate.call(this,args);};
G__48742.cljs$lang$maxFixedArity = 0;
G__48742.cljs$lang$applyTo = (function (arglist__48744){
var args = cljs.core.seq(arglist__48744);
return G__48742__delegate(args);
});
G__48742.cljs$core$IFn$_invoke$arity$variadic = G__48742__delegate;
return G__48742;
})()
;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__48752){
...
var props = map__48753__$1;
var class$ = cljs.core.get.call(null,map__48753__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__48769){
var map__48770 = p__48769;
var map__48770__$1 = ((((!((map__48770 == null)))?((((map__48770.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48770.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48770):map__48770);
var on_write = cljs.core.get.call(null,map__48770__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__48770,map__48770__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__48770,map__48770__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__48802){
var map__48803 = p__48802;
var map__48803__$1 = ((((!((map__48803 == null)))?((((map__48803.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48803.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48803):map__48803);
var synthetic_on_update = cljs.core.get.call(null,map__48803__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__48803__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
if(cljs.core.truth_((function (){var and__30060__auto__ = !((jsprops == null));
if(and__30060__auto__){
var and__30060__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__48810 = jsprops;
(G__48810["defaultValue"] = value);

(G__48810["onChange"] = ((function (G__48810,v,value,on_change,on_change__$1,map__48803,map__48803__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__48796_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__48796_SHARP_);
});})(G__48810,v,value,on_change,on_change__$1,map__48803,map__48803__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__48835 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__48835,(0),null);
var id = cljs.core.nth.call(null,vec__48835,(1),null);
var class$ = cljs.core.nth.call(null,vec__48835,(2),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___48842 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5282__auto___48842 == null)){
} else {
var key_48844 = temp__5282__auto___48842;
(jsprops["key"] = key_48844);
}

return reagent.impl.template.node$module$react.createElement.call(null,c,jsprops);
});
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__48848){
var map__48849 = p__48848;
var map__48849__$1 = ((((!((map__48849 == null)))?((((map__48849.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48849.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48849):map__48849);
var synthetic_input = cljs.core.get.call(null,map__48849__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__48851 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__48851["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__48852 = wrapped;
(G__48852["syntheticInput"] = true);

return G__48852;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__48853 = wrapped__$1;
(G__48853["syntheticOnChange"] = on_change);

return G__48853;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__48854 = wrapped__$2;
(G__48854["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__30072__auto__ = synthetic_input;
...
var len__31349__auto___48991 = arguments.length;
var i__31350__auto___48992 = (0);
while(true){
if((i__31350__auto___48992 < len__31349__auto___48991)){
args__31356__auto__.push((arguments[i__31350__auto___48992]));

var G__48995 = (i__31350__auto___48992 + (1));
i__31350__auto___48992 = G__48995;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31357__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq48901){
var G__48902 = cljs.core.first.call(null,seq48901);
var seq48901__$1 = cljs.core.next.call(null,seq48901);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__48902,seq48901__$1);
});
...
break;
default:
var G__49040 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__49040;
continue;
...
var n__31115__auto___49062 = a.length;
var i_49064 = (0);
while(true){
if((i_49064 < n__31115__auto___49062)){
(a[i_49064] = reagent.impl.template.as_element.call(null,(a[i_49064])));

var G__49065 = (i_49064 + (1));
i_49064 = G__49065;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31115__auto___49068 = a.length;
var i_49069 = (0);
while(true){
if((i_49069 < n__31115__auto___49068)){
var val_49070 = (a[i_49069]);
if((cljs.core.vector_QMARK_.call(null,val_49070)) && ((reagent.impl.template.key_from_vec.call(null,val_49070) == null))){
(o["no-key"] = true);
} else {
}

(a[i_49069] = reagent.impl.template.as_element.call(null,val_49070));
...
var ctx = ({});
var vec__49072 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__49072,(0),null);
var derefed = cljs.core.nth.call(null,vec__49072,(1),null);
...
var G__49075 = (cljs.core.count.call(null,argv) - first_child);
switch (G__49075) {
case (0):
return reagent.impl.template.node$module$react.createElement.call(null,comp,jsprops);

break;
case (1):
return reagent.impl.template.node$module$react.createElement.call(null,comp,jsprops,reagent.impl.template.as_element.call(null,cljs.core.nth.call(null,argv,first_child,null)));

break;
default:
return reagent.impl.template.node$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__49075){
...
//# sourceMappingURL=template.js.map?rel=1510360405401
