...
var or__30072__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
figwheel.client.utils.create_custom_event = (function figwheel$client$utils$create_custom_event(event_name,data__$1){
if(cljs.core.not.call(null,goog.userAgent.product.IE)){
return (new CustomEvent(event_name,(function (){var obj37255 = {"detail":data__$1};
return obj37255;
})()));
} else {
var event = document.createEvent("CustomEvent");
event.initCustomEvent(event_name,false,false,data__$1);

return event;
}
});
figwheel.client.utils.dispatch_custom_event = (function figwheel$client$utils$dispatch_custom_event(event_name,data__$1){
if(cljs.core.truth_((function (){var and__30060__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30060__auto__)){
var and__30060__auto____$1 = goog.object.get(window,"CustomEvent");
...
return document.body.dispatchEvent(figwheel.client.utils.create_custom_event.call(null,event_name,data__$1));
} else {
return null;
}
});
...
var f = (function (){var pred__37262 = cljs.core._EQ_;
var expr__37263 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37262.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37263))){
return ((function (pred__37262,expr__37263){
return (function (p1__37256_SHARP_){
return console.warn(p1__37256_SHARP_);
});
;})(pred__37262,expr__37263))
} else {
if(cljs.core.truth_(pred__37262.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37263))){
return ((function (pred__37262,expr__37263){
return (function (p1__37257_SHARP_){
return console.debug(p1__37257_SHARP_);
});
;})(pred__37262,expr__37263))
} else {
if(cljs.core.truth_(pred__37262.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37263))){
return ((function (pred__37262,expr__37263){
return (function (p1__37258_SHARP_){
return console.error(p1__37258_SHARP_);
});
;})(pred__37262,expr__37263))
} else {
return ((function (pred__37262,expr__37263){
return (function (p1__37259_SHARP_){
return console.log(p1__37259_SHARP_);
});
;})(pred__37262,expr__37263))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37266){
var map__37267 = p__37266;
var map__37267__$1 = ((((!((map__37267 == null)))?((((map__37267.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37267.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__37267):map__37267);
var opts = map__37267__$1;
var eval_fn = cljs.core.get.call(null,map__37267__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37269_SHARP_);
});})(new_def))
);
...
return (function (p__37270){
var vec__37271 = p__37270;
var ky = cljs.core.nth.call(null,vec__37271,(0),null);
var v = cljs.core.nth.call(null,vec__37271,(1),null);
...
if(cljs.core.truth_((function (){var and__30060__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1510085334762
