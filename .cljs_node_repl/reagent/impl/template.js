...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__44622__auto__,writer__44623__auto__,opt__44624__auto__){
return cljs.core._write.call(null,writer__44623__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__46493 = o;
(G__46493[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__46494__delegate = function (args){
...
while (G__46495__i < G__46495__a.length) {G__46495__a[G__46495__i] = arguments[G__46495__i + 0]; ++G__46495__i;}
  args = new cljs.core.IndexedSeq(G__46495__a,0,null);
} 
return G__46494__delegate.call(this,args);};
G__46494.cljs$lang$maxFixedArity = 0;
G__46494.cljs$lang$applyTo = (function (arglist__46496){
var args = cljs.core.seq(arglist__46496);
return G__46494__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__43939__auto__ = !((jsprops == null));
if(and__43939__auto__){
var and__43939__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__43939__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__43939__auto____$1;
}
} else {
...
var G__46499 = jsprops;
(G__46499["defaultValue"] = value);

(G__46499["onChange"] = ((function (G__46499,v,value,on_change){
return (function (p1__46498_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__46498_SHARP_);
});})(G__46499,v,value,on_change))
);
...
var vec__46502 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__46502,(0),null);
var id = cljs.core.nth.call(null,vec__46502,(1),null);
var class$ = cljs.core.nth.call(null,vec__46502,(2),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___46506 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5282__auto___46506 == null)){
} else {
var key_46507 = temp__5282__auto___46506;
(jsprops["key"] = key_46507);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__46508 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__46508["name"] = c);
...
var len__45228__auto___46513 = arguments.length;
var i__45229__auto___46514 = (0);
while(true){
if((i__45229__auto___46514 < len__45228__auto___46513)){
args__45235__auto__.push((arguments[i__45229__auto___46514]));

var G__46515 = (i__45229__auto___46514 + (1));
i__45229__auto___46514 = G__46515;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45236__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq46511){
var G__46512 = cljs.core.first.call(null,seq46511);
var seq46511__$1 = cljs.core.next.call(null,seq46511);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__46512,seq46511__$1);
});
...
break;
default:
var G__46518 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__46518;
continue;
...
var n__44994__auto___46520 = a.length;
var i_46521 = (0);
while(true){
if((i_46521 < n__44994__auto___46520)){
(a[i_46521] = reagent.impl.template.as_element.call(null,(a[i_46521])));

var G__46522 = (i_46521 + (1));
i_46521 = G__46522;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__44994__auto___46523 = a.length;
var i_46524 = (0);
while(true){
if((i_46524 < n__44994__auto___46523)){
var val_46525 = (a[i_46524]);
if((cljs.core.vector_QMARK_.call(null,val_46525)) && ((reagent.impl.template.key_from_vec.call(null,val_46525) == null))){
(o["no-key"] = true);
} else {
}

(a[i_46524] = reagent.impl.template.as_element.call(null,val_46525));

var G__46526 = (i_46524 + (1));
i_46524 = G__46526;
continue;
} else {
}
...
var ctx = ({});
var vec__46527 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__46527,(0),null);
var derefed = cljs.core.nth.call(null,vec__46527,(1),null);
...
var G__46530 = (cljs.core.count.call(null,argv) - first_child);
switch (G__46530) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__46530){
