...
var G__46074 = o;
(G__46074[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__46085__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__46085 = function (var_args){
var args = null;
...
return G__46085__delegate.call(this,args);};
G__46085.cljs$lang$maxFixedArity = 0;
G__46085.cljs$lang$applyTo = (function (arglist__46089){
var args = cljs.core.seq(arglist__46089);
return G__46085__delegate(args);
});
G__46085.cljs$core$IFn$_invoke$arity$variadic = G__46085__delegate;
return G__46085;
})()
;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__46093){
...
var props = map__46094__$1;
var class$ = cljs.core.get.call(null,map__46094__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__46102){
...
var on_write = cljs.core.get.call(null,map__46103__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__46103,map__46103__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__46103,map__46103__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__46119){
...
var synthetic_on_update = cljs.core.get.call(null,map__46120__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__46120__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__46122 = jsprops;
(G__46122["defaultValue"] = value);

(G__46122["onChange"] = ((function (G__46122,v,value,on_change,on_change__$1,map__46120,map__46120__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__46115_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__46115_SHARP_);
});})(G__46122,v,value,on_change,on_change__$1,map__46120,map__46120__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__46143 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__46143,(0),null);
var id = cljs.core.nth.call(null,vec__46143,(1),null);
var class$ = cljs.core.nth.call(null,vec__46143,(2),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___46153 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5282__auto___46153 == null)){
} else {
var key_46154 = temp__5282__auto___46153;
(jsprops["key"] = key_46154);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__46159){
...
var synthetic_input = cljs.core.get.call(null,map__46160__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__46164 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__46164["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__46165 = wrapped;
(G__46165["syntheticInput"] = true);

return G__46165;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__46166 = wrapped__$1;
(G__46166["syntheticOnChange"] = on_change);

return G__46166;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__46167 = wrapped__$2;
(G__46167["syntheticOnUpdate"] = on_update);
...
var len__31349__auto___46189 = arguments.length;
var i__31350__auto___46190 = (0);
while(true){
if((i__31350__auto___46190 < len__31349__auto___46189)){
args__31356__auto__.push((arguments[i__31350__auto___46190]));

var G__46191 = (i__31350__auto___46190 + (1));
i__31350__auto___46190 = G__46191;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq46185){
var G__46186 = cljs.core.first.call(null,seq46185);
var seq46185__$1 = cljs.core.next.call(null,seq46185);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__46186,seq46185__$1);
});
...
break;
default:
var G__46199 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__46199;
continue;
...
var n__31115__auto___46205 = a.length;
var i_46206 = (0);
while(true){
if((i_46206 < n__31115__auto___46205)){
(a[i_46206] = reagent.impl.template.as_element.call(null,(a[i_46206])));

var G__46207 = (i_46206 + (1));
i_46206 = G__46207;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31115__auto___46210 = a.length;
var i_46211 = (0);
while(true){
if((i_46211 < n__31115__auto___46210)){
var val_46212 = (a[i_46211]);
if((cljs.core.vector_QMARK_.call(null,val_46212)) && ((reagent.impl.template.key_from_vec.call(null,val_46212) == null))){
(o["no-key"] = true);
} else {
}

(a[i_46211] = reagent.impl.template.as_element.call(null,val_46212));

var G__46213 = (i_46211 + (1));
i_46211 = G__46213;
continue;
} else {
}
...
var ctx = ({});
var vec__46214 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__46214,(0),null);
var derefed = cljs.core.nth.call(null,vec__46214,(1),null);
...
var G__46217 = (cljs.core.count.call(null,argv) - first_child);
switch (G__46217) {
case (0):
...
break;
default:
return reagent.impl.template.node$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__46217){
...
//# sourceMappingURL=template.js.map?rel=1510360395655
