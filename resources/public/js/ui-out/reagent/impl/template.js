...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__12377__auto__,writer__12378__auto__,opt__12379__auto__){
return cljs.core._write.call(null,writer__12378__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__17114 = o;
(G__17114[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__17115__delegate = function (args){
...
while (G__17116__i < G__17116__a.length) {G__17116__a[G__17116__i] = arguments[G__17116__i + 0]; ++G__17116__i;}
  args = new cljs.core.IndexedSeq(G__17116__a,0,null);
} 
return G__17115__delegate.call(this,args);};
G__17115.cljs$lang$maxFixedArity = 0;
G__17115.cljs$lang$applyTo = (function (arglist__17117){
var args = cljs.core.seq(arglist__17117);
return G__17115__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__11694__auto__ = !((jsprops == null));
if(and__11694__auto__){
var and__11694__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__11694__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__11694__auto____$1;
}
} else {
...
var G__17120 = jsprops;
(G__17120["defaultValue"] = value);

(G__17120["onChange"] = ((function (G__17120,v,value,on_change){
return (function (p1__17119_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17119_SHARP_);
});})(G__17120,v,value,on_change))
);
...
var vec__17123 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17123,(0),null);
var id = cljs.core.nth.call(null,vec__17123,(1),null);
var class$ = cljs.core.nth.call(null,vec__17123,(2),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___17127 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5282__auto___17127 == null)){
} else {
var key_17128 = temp__5282__auto___17127;
(jsprops["key"] = key_17128);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__17129 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__17129["name"] = c);
...
var len__12983__auto___17134 = arguments.length;
var i__12984__auto___17135 = (0);
while(true){
if((i__12984__auto___17135 < len__12983__auto___17134)){
args__12990__auto__.push((arguments[i__12984__auto___17135]));

var G__17136 = (i__12984__auto___17135 + (1));
i__12984__auto___17135 = G__17136;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__12991__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17132){
var G__17133 = cljs.core.first.call(null,seq17132);
var seq17132__$1 = cljs.core.next.call(null,seq17132);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__17133,seq17132__$1);
});
...
break;
default:
var G__17139 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__17139;
continue;
...
var n__12749__auto___17141 = a.length;
var i_17142 = (0);
while(true){
if((i_17142 < n__12749__auto___17141)){
(a[i_17142] = reagent.impl.template.as_element.call(null,(a[i_17142])));
...
var a = cljs.core.into_array.call(null,s);
var n__12749__auto___17144 = a.length;
var i_17145 = (0);
while(true){
if((i_17145 < n__12749__auto___17144)){
var val_17146 = (a[i_17145]);
if((cljs.core.vector_QMARK_.call(null,val_17146)) && ((reagent.impl.template.key_from_vec.call(null,val_17146) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17145] = reagent.impl.template.as_element.call(null,val_17146));

var G__17147 = (i_17145 + (1));
i_17145 = G__17147;
continue;
} else {
}
...
var ctx = ({});
var vec__17148 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__17148,(0),null);
var derefed = cljs.core.nth.call(null,vec__17148,(1),null);
...
var G__17151 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17151) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__17151){
